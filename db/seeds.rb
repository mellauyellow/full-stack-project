...
40.times do
  review1 = Review.create(body: Faker::Hipster.paragraph(3), neighborhood_id: Faker::Number.between(1, 87), user_id: 1, created_at: Faker::Date.between(2.years.ago, Date.today), good_for_pets: Faker::Boolean.boolean, good_for_bikes: Faker::Boolean.boolean, good_for_singles: Faker::Boolean.boolean, good_for_families: Faker::Boolean.boolean, street_parking: Faker::Boolean.boolean)
  review2 = Review.create(body: Faker::Hipster.paragraph(4), neighborhood_id: Faker::Number.between(1, 87), user_id: 2, created_at: Faker::Date.between(2.years.ago, Date.today), good_for_pets: Faker::Boolean.boolean, good_for_bikes: Faker::Boolean.boolean, good_for_singles: Faker::Boolean.boolean, good_for_families: Faker::Boolean.boolean, street_parking: Faker::Boolean.boolean)
  review3 = Review.create(body: Faker::Lorem.paragraph(5), neighborhood_id: Faker::Number.between(1, 87), user_id: 3, created_at: Faker::Date.between(2.years.ago, Date.today), good_for_pets: Faker::Boolean.boolean, good_for_bikes: Faker::Boolean.boolean, good_for_singles: Faker::Boolean.boolean, good_for_families: Faker::Boolean.boolean, street_parking: Faker::Boolean.boolean)
  ...
  review1.images.create(url: "http://res.cloudinary.com/mellauyellow/image/upload/c_scale,w_906/v1478837079/o-YELLOW-BUILDING-facebook_dmx6bu.jpg", user_id: 1)
  review1.images.create(url: "http://res.cloudinary.com/mellauyellow/image/upload/c_scale,w_792/v1478836859/Bayview-jumbo_arzqfz.jpg", user_id: 1)
  review2.images.create(url: "http://res.cloudinary.com/mellauyellow/image/upload/v1478838731/chinatown-1-960x600_t8fokp.jpg", user_id: 2)
  review3.images.create(url: "http://res.cloudinary.com/mellauyellow/image/upload/v1478837870/0_4200_0_2800_one_SF_RichmondDistrict_OdessaShekar-13_cso99f.jpg", user_id: 3)
end
